...
if __name__ == "__main__":
    ...
    t2 = Thread(target=copy, args=('TestFile2.mp4', 'TestFile6.mp4'))
    t3 = Thread(target=copy, args=('TestFile3.mp4', 'TestFile7.mp4'))
    t4 = Thread(target=copy, args=('TestFile4.mp4', 'TestFile8.mp4'))
    t1.start()
    t2.start()
    t3.start()
    t4.start()
